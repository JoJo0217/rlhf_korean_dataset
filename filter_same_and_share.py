...
# 첫 번째 jsonl 파일을 읽습니다.
with open("./step3/raw_data/step3_step1_data.jsonl", "r") as file1:
    data1 = [json.loads(line) for line in file1.readlines()]

# 두 번째 jsonl 파일을 읽습니다.
with open("./step1/llm_team/hatespeech.jsonl", "r") as file2:
    data2 = [json.loads(line) for line in file2.readlines()]

# 두 번째 파일에 있는 prompts를 추출합니다.
prompts_in_file2 = {item["instruction"] for item in data2}
